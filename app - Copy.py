...
# Sample portfolio data (aligned with Akhila Koppula's resume)
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Space Fund Reality (SFR) — Analysis using AI & ML',
        'description': 'Applied AI/ML and NLP techniques to analyze funding history, technical milestones, patents, market trends, and public disclosures. Built scoring models to assess risk and investment readiness of space ventures and automated feature extraction from reports and news.',
        'image': 'sfr_analysis.jpg',
    ...
    },
    {
        ...
        'description': 'A browser-based memory card matching game implementing card shuffling, match validation, score tracking, and responsive UI to improve cognitive skills and user engagement.',
    ...
    },
    {
        ...
        'description': 'Personal portfolio site showcasing academic projects, skills, and contact information.',
        'image': 'portfolio_site.jpg',
